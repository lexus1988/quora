                ...
                <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.project.name" id="uname" class="username form-control input-sm" placeholder="Enter project name" required ng-minlength="3"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.project.description" id="pdescription" class="username form-control input-sm" placeholder="Enter project description" required ng-minlength="3"/>
                            </div>
                        </div>
                    </div>
